(() => {
    ...
    function initSliders() {
        if (document.querySelector(".networks__slider")) new core(".networks__slider", {
            modules: [ Navigation ],
            observer: true,
            autoHeight: true,
            speed: 800,
        ...
        if (document.querySelector(".top-charity-slider__slider")) new core(".top-charity-slider__slider", {
            modules: [ Autoplay ],
            loop: true,
            slidesPerView: "auto",
            speed: 4e3,
        ...
        if (document.querySelector(".bottom-charity-slider__slider")) new core(".bottom-charity-slider__slider", {
            modules: [ Autoplay ],
            loop: true,
            slidesPerView: "auto",
            speed: 4e3,
